 ...
 */
public final class ValidationContextPage {

    private ValidationContextPage() {}
    ...
    public static void addError(String message) {
        ...
        try {
            com.salesforce.marketingcloud.context.ValidationContext.getInstance().addResult("Runtime Error", false, message, "CRITICAL");
        } catch (Throwable t) {
    ...
    public static void clear() {
        ...
        try {
            com.salesforce.marketingcloud.context.ValidationContext.getInstance().clear();
        } catch (Throwable t) {
            // ignore
        }
    }
